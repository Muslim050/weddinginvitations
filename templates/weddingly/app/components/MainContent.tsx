  ...
  return (
    ...
    >
        ...
        {isOpen && (
          <>
            ...
            >
              ...
              >
                <p className="font-legan text-sm my-2">{t.theGroom}</p>
                <h1 className="text-xl md:text-3xl text-white  font-ovo">
                  {config.groom}
                </h1>
                <h3 className="font-thesignature text-2xl">{t.about} {config.groomNickName}</h3>
            ...
            >
              ...
              >
                <p className="font-legan text-sm my-2">{t.theBride}</p>
                <h1 className="text-xl md:text-3xl text-white  font-ovo">
                  {config.bride}
                </h1>
                <h3 className="font-thesignature text-2xl">{t.about} {config.brideNickName}</h3>
                <p className="text-sm mt-5 font-legan text-[#CCCCCC]">
                  {config.brideBio}
                </p>
                <Link
            ...
            >
              ...
              >
                ...
                <h1 className="text-2xl w-[200px] text-center text-white  font-ovo uppercase">
                  {formatWeekday(lang, config.eventDate)} <br /> {formatDate(lang, config.eventDate)}
                </h1>
                {config.nikoh.enabled && (
                  <div className="mt-5 mx-auto flex flex-col items-center">
                    <h3 className="uppercase font-ovo text-sm text-center mt-5 mb-2">
                      {t.nikoh} <br /> {config.nikoh.time}
                    </h3>
                    <p className="text-sm text-center  font-legan text-white">
                      {config.nikohPlace} <br /> {config.nikohPlaceDetails}
                    </p>
                    <Link
                      href={config.nikoh.googleMapsLink}
                      target="_blank"
                ...
                {config.reception.enabled && (
                  <div className="mt-5 mx-auto flex  flex-col items-center">
                    <h3 className="uppercase font-ovo text-sm text-center mt-5 mb-2">
                      {t.reception} <br /> {config.reception.time}
                    </h3>
                    <p className="text-sm text-center  font-legan text-white">
                      {config.receptionPlace} <br /> {config.receptionPlaceDetails}
                    </p>
                    <Link
                      href={config.reception.googleMapsLink}
                      target="_blank"
                      className="cursor-pointer hover:text-white/20 text-sm rounded-full flex items-center gap-x-2 text-center font-legan mt-5 bg-[#808080] w-fit px-4 py-2 text-white"
                    >
                      {t.map}
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 rounded-full border border-white/40 bg-black/40 px-4 py-2 font-legan text-[10px] uppercase tracking-[0.2em] text-white backdrop-blur transition hover:bg-white hover:text-black"
      >
        {t.langLabel}
      </button>
