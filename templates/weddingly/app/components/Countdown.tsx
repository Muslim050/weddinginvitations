  ...
  return (
    <div className="flex space-x-4 mt-5 text-center font-legan">
      <div className="flex flex-col">
        ...
        <span className="text-sm uppercase">{t.days}</span>
      </div>
      <div className="flex flex-col">
        <span className="text-4xl font-bold">{timeLeft.hours}</span>
        <span className="text-sm uppercase">{t.hours}</span>
      </div>
      <div className="flex flex-col">
        <span className="text-4xl font-bold">{timeLeft.minutes}</span>
        <span className="text-sm uppercase">{t.minutes}</span>
      </div>
      <div className="flex flex-col">
        <span className="text-4xl font-bold">{timeLeft.seconds}</span>
        <span className="text-sm uppercase">{t.seconds}</span>
      </div>
    </div>
  );
};
