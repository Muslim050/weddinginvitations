...
export const metadata: Metadata = {
  title: `Свадьба ${config.coupleNames} | ${config.coupleNames} to‘yi`,
  description: `Приглашение на свадьбу ${config.coupleNames}. ${config.coupleNames} nikoh to‘yiga taklifnoma.`,
};
