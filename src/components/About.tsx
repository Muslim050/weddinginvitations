...
/**
 * Блок доверия. Число клиентов задаёт владелец — правьте его здесь и только
 * на реальную цифру: она проверяется одним вопросом в переписке.
 * Выдуманных отзывов от несуществующих пар здесь по-прежнему нет.
 */
const CLIENTS = 200;
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
        <div>
          ...
          <h2 className="mt-5 font-display text-[clamp(1.9rem,6vw,3.4rem)] leading-tight">
            Более {CLIENTS} клиентов
          </h2>
        </div>

        <div className="space-y-5 text-lg leading-relaxed text-ash">
          <p>
            {owner ? `Меня зовут ${owner}. ` : ""}Через эти приглашения прошло
            больше {CLIENTS} свадеб: никох и той, десятки и сотни гостей,
            русский и узбекский в одной ссылке. Сезон научил, где гости
            путаются и что переспрашивают у родителей.
          </p>
          <p>
            Проверять меня на слово не нужно:{" "}
