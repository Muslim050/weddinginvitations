...
Лендинг и три шаблона в одной папке:
...
Все три шаблона переведены на **русский и узбекский** — гость переключает язык одной
...
процесса. При деплое внешние адреса можно переопределить переменными из `.env.example`.
